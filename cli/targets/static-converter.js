...
var protobuf   = require("../.."),
    ...
    typeConverter = require('./converters/registered-type-converter');
...
function buildType(ref, type) {
    ...
    if (config.convert) {
        ...
        buildFunction(type, typeConverter.GET_OBJECT_MAP_FN, typeConverter.getObjectMap(type, function(field) {return toJsType(field);}));
        ...
        buildFunction(type, "fromObject", typeConverter.fromObject(type));
        ...
        buildFunction(type, "toObject", typeConverter.toObject(type));
